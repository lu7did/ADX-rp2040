...
/* Public functions */
/********************/
MbedI2C myWire(I2C_SDA,I2C_SCL);
...
bool Si5351::init(uint8_t xtal_load_c, uint32_t xo_freq, int32_t corr)
{
	...
	myWire.beginTransmission(i2c_bus_addr);
	uint8_t reg_val;
  reg_val = myWire.endTransmission();
...
uint8_t Si5351::si5351_read(uint8_t addr)
{
	...
	myWire.requestFrom(i2c_bus_addr, (uint8_t)1, (uint8_t)false);
