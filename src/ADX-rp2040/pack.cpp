...
char A0_ft8[50] = " 0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ+-./?";  //41 characters
char A1_ft8[50] = " 0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ";
char A2_ft8[50] = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ";
char A3_ft8[50] = "0123456789";
char A4_ft8[50] = " ABCDEFGHIJKLMNOPQRSTUVWXYZ";
...
int32_t pack28(const char *callsign)
{
    ...
    if ((i0 = char_index(A1_ft8, c6[0])) >= 0 && (i1 = char_index(A2_ft8, c6[1])) >= 0 &&
        (i2 = char_index(A3_ft8, c6[2])) >= 0 && (i3 = char_index(A4_ft8, c6[3])) >= 0 &&
        (i4 = char_index(A4_ft8, c6[4])) >= 0 && (i5 = char_index(A4_ft8, c6[5])) >= 0)
    {
...
void packtext77(const char *text, uint8_t *b77)
{
    ...
    for (int j = 0; j < 13; ++j)
    {
        ...
        if (j < length)
        {
            int q = char_index(A0_ft8, text[j]);
            x = (q > 0) ? q : 0;
        }
        else
        {
